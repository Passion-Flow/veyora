 ...
 *   more     hidden behind the "More fields" disclosure (login only)
 *   hintKey  i18n key for an explanatory hint under the field
 */
export const TEMPLATE_FIELDS = Object.freeze({
  login: Object.freeze([
    Object.freeze({ k: 'name', labelKey: 'field.name', phKey: 'ph.name', hintKey: 'field.nameHint', span: true }),
    ...
    Object.freeze({ k: 'totpSecret', labelKey: 'field.totpSecret', phKey: 'ph.totpSecret', hintKey: 'field.totpHint', more: true }),
    Object.freeze({ k: 'notes', labelKey: 'field.notes', phKey: 'ph.notes', textarea: true, span: true, more: true }),
    Object.freeze({ k: 'tags', labelKey: 'field.tags', phKey: 'ph.tags', hintKey: 'field.tagsHint', span: true, more: true }),
  ]),
  note: Object.freeze([
    ...
    Object.freeze({ k: 'tags', labelKey: 'field.tags', phKey: 'ph.tags', hintKey: 'field.tagsHint', span: true }),
  ]),
