...
The checked-in browser artifacts live in `apps/web/src/wasm/`; `make build-wasm`
from the repository root is the single generation command and destination
(see `tools/codegen/manifest.json`).
